          ...
          <div className="max-w-[600px] h-max border max-[425px]:border-0 rounded-lg my-5 dark:bg-[#1e1e1f] transition duration-300">
            <div className="flex justify-around p-5">
              ...
              <div className="flex flex-col justify-around">
                <h2 className="text-3xl font-semibold text-center dark:text-white transition duration-300">
                  {user.name}
                </h2>
                <button
                  onClick={() => {
                ...
                <div className="flex">
                  <p className="px-2 font-medium dark:text-white transition duration-300">
